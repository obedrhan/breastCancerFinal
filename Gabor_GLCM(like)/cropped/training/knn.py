...
if __name__ == "__main__":
    ...
    CSV_FILE = os.path.join(BASE_DIR, "Gabor_GLCM(like)/data/glcm_gabor_features_cropped_training.csv")
    ...
    joblib.dump(knn_model, os.path.join(MODEL_DIR, "knn_gabor_glcm_cropped.pkl"))
    joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_gabor_glcm_cropped.pkl"))
