...
def load_data(features_file):
    ...
    def normalize_label(label):
        if isinstance(label, str):
            label = label.strip().lower()  # Handle whitespace + case
    ...
    # Drop 'Image Name' and 'Label' to get features
...
if __name__ == "__main__":
    ...
    joblib.dump(knn_model, os.path.join(model_dir, "knn_cropped_hog.pkl"))
    joblib.dump(scaler, os.path.join(model_dir, "scaler_knn_hog_cropped.pkl"))
