...
if __name__ == "__main__":
    ...
    joblib.dump(rf_model, os.path.join(model_dir, "random_forest_cropped_glcm.pkl"))
    joblib.dump(scaler, os.path.join(model_dir, "scaler_rf_glcm_cropped.pkl"))

    print("✅ Random Forest model and scaler (GLCM) saved.")