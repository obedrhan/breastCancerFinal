...
if __name__ == "__main__":
    ...
    rf_model = joblib.load(os.path.join(model_dir, "random_forest_model_hog_lbp_cropped.pkl"))
    scaler = joblib.load(os.path.join(model_dir, "scaler_rf_hog_lbp_cropped.pkl"))
