...
if __name__ == "__main__":
    ...
    joblib.dump(rf_model, os.path.join(model_dir, "random_forest_model_hog_lbp_cropped.pkl"))
    joblib.dump(scaler, os.path.join(model_dir, "scaler_rf_hog_lbp_cropped.pkl"))
