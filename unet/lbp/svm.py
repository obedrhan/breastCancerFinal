...
SCALER_FILE  = os.path.join(OUT_DIR, "scaler_svm.pkl")
MODEL_FILE   = os.path.join(OUT_DIR, "svm_model.pkl")
SUMMARY_CSV  = os.path.join(OUT_DIR, "svm_summary.csv")
RANDOM_STATE = 42
...
# lowercase pathology and unify labels
