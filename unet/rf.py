...
MODEL_FILE   = os.path.join(OUT_DIR, "rf_hog_lbp_model.pkl")
SUMMARY_CSV  = os.path.join(OUT_DIR, "rf_hog_lbp_summary.csv")
RANDOM_STATE = 42
...
if df['target'].isnull().any():
    ...
    print(f"⚠️ Dropping {count} rows with unknown pathology labels")
