...
MODEL_PATH = os.path.join(BASE_DIR, "GABOR_GLCM/models/xgboost_glcm_gabor_segmented.pkl")
SCALER_PATH = os.path.join(BASE_DIR, "GABOR_GLCM/models/scaler_glcm_gabor_xg_segmented.pkl")
