...
# === SAVE MODEL + SCALER ===
joblib.dump(grid.best_estimator_, os.path.join(MODEL_DIR, "svm_gabor_glcm_segmented.pkl"))
joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_svm_gabor_glcm_segmented.pkl"))
