...
# === SAVE MODEL + SCALER ===
joblib.dump(grid.best_estimator_, os.path.join(MODEL_DIR, "knn_gabor_glcm_cropped.pkl"))
joblib.dump(scaler, os.path.join(MODEL_DIR, "scaler_knn_gabor_glcm_cropped.pkl"))
