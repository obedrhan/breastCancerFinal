...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), os.path.join(BASE_DIR, 'Segmented_deep_learning/Segmented_deep_learning/custom_cnn_segmented.pth'))
    print(" Model saved to Segmented_deep_learning/custom_cnn.pth ")