...
MODEL_PATH = "efficientnet_b0_segmented_model.pth"
...
model.classifier[1] = nn.Linear(model.classifier[1].in_features, 2)  # Assuming 2-class output
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig("confusion_matrix_efficientnet_b0.png")
plt.show()