...
# Load the features
hog_df = pd.read_csv('/Users/ecekocabay/Desktop/2025SPRING/ CNG492/DDSM/data/hog_features_segmented.csv')
lbp_df = pd.read_csv('/Users/ecekocabay/Desktop/2025SPRING/ CNG492/DDSM/data/lbp_features_with_labels.csv')
